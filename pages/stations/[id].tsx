...
const Station = ({ details }: { details: any }) => {
  console.log(details);
  ...
  const deleteStation = (name: string, _id: any) => {
    //popup modal
                  ...
                  <div className="grid grid-cols-2 w-full text-darkGray gap-5">
                    ...
                    <div className="flex flex-col w-full gap-3 relative mb-2">
                      ...
                      <input
                        ...
                        name="englishName"
                        id="englishName"
                        className={`w-full h-12 rounded-md border border-lightGray shadow-md  px-2  ${formik.touched.englishName &&
