...
export default function Revenue({ data }: { data: cashType[] }) {
  ...
  const [pageData, setPageData] = useState<cashType[]>([
    {
      salesCases: "test",
      amount: "test",
      account: "test",
    ...
    <>
      {isLoading ? (
        ...
        <div className="flex flex-col justify-center items-center px-5 h-full ">
          <PageHeader pageTitle="pages.cash" newUrl={`/accounting/cash/new`} />
            ...
            <div className="flex justify-center items-center w-full  py-3">
              ...
              <div className="flex justify-center items-center">
                ...
                <Button
                  ...
                  handleOnClick={() => {
                    router.push(
                      `/accounting/cash/${selectedData[0]}?isEdit=true`
                    );
                  }}
                />
                <Button
            ...
            <div className="main-table w-full h-[80%] overflow-auto">
              <table className={` w-full`}>
                ...
                <tbody className="main-table overflow-auto">
                  {pageData
                    ?.filter((res: cashType) => !res.isDeleted)
                    .map((res: cashType, index: number) => {
                      if (index >= startingIndex && index < currentPage * 10) {
                        return (
                          <tr key={res._id} className=" text-left h-full">
                            ...
                            <td>
                              <Link href={`/accounting/cash/${res._id}`}>
